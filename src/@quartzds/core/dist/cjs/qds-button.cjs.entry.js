...
const Button = class {
    constructor(hostRef) {
        ...
        this.setCustomValidity = (error) => {
            if (error)
                this.internals.setValidity(controls.CUSTOM_ERROR_FLAGS, error, __classPrivateFieldGet(this, _Button_button, "f"));
            else
    ...
    textChanged() {
        ...
        if (!__classPrivateFieldGet(this, _Button_span, "f"))
            return;
        this.tooltip = helpers.isOverflowing(__classPrivateFieldGet(this, _Button_span, "f"));
    ...
    render() {
        ...
        const ariaLabel = hasBadgeProperties
            ...
            : this.text;
        return (index.h("div", { key: 'fa26ab96409ab7594ea6cfeda85a5ab5bc246f3b', class: "qds-container" }, index.h(Tag, { key: '8b1afcffde6991b7265e4222ca7e2c820d336caa', "aria-hidden": "true", class: {
                'qds-button': true,
...
exports.qds_button = Button;

//# sourceMappingURL=qds-button.cjs.entry.js.map