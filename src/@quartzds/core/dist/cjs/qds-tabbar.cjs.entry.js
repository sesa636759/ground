...
const Tabbar = class {
    ...
    render() {
        return (index.h("div", { key: '1bac1d9e7275ef07b70ebe6272723657ad28a6dd', class: { 'qds-vertical-divider': this.orientation === 'vertical' }, "data-layer": this.layer, "data-level": this.level }, index.h("div", { key: 'f5c335aef291edf70ce9ee481933d83d6ceac038', class: "qds-tabbar" }, index.h("div", { key: '6f93b1bea5382f9dfa4d7a89783e172ae0f11f1b', class: {
                'qds-flex': !(this.disableEndArrow && this.disableStartArrow),
                'qds-hidden': (this.disableEndArrow && this.disableStartArrow) ||
                    this.orientation === 'vertical',
            } }, index.h("qds-button", { key: '8632fccf7dce7e7e219a7ac4281b0aec3ce8bb8e', text: "show previous tab", importance: "subdued", "icon-name": "dropdown", "icon-library": "core", class: "qds-arrow-start", onClick: __classPrivateFieldGet(this, _Tabbar_scrollToStart, "f"), disabled: this.disableStartArrow, iconOnly: true })), index.h("ul", { key: '1d7e4207088326204c2aa39f77225bc6ed1dd7ba', class: {
                'qds-tabs': true,
            ...
            }, onClick: __classPrivateFieldGet(this, _Tabbar_onClick, "f"), onKeyDown: __classPrivateFieldGet(this, _Tabbar_onKeyDown, "f"), onMouseDown: __classPrivateFieldGet(this, _Tabbar_onMouseDown, "f"), onScroll: __classPrivateFieldGet(this, _Tabbar_onScroll, "f"), ...__classPrivateFieldGet(this, _Tabbar_inheritedAttributes, "f") }, index.h("slot", { key: '1cbde9037a47302cb4969c7e27580f465f577994', onSlotchange: __classPrivateFieldGet(this, _Tabbar_onSlotchange, "f") })), index.h("div", { key: '718ed1e9a9e28f8611ffb770dd25c605665a2d04', class: {
                'qds-flex': !(this.disableEndArrow && this.disableStartArrow),
                'qds-hidden': (this.disableEndArrow && this.disableStartArrow) ||
                    this.orientation === 'vertical',
            } }, index.h("qds-button", { key: '9c750f868d16309052a129d844a6a1ed9bf92987', text: "show next tab", "icon-name": "dropdown", "icon-library": "core", importance: "subdued", class: "qds-arrow-end", onClick: __classPrivateFieldGet(this, _Tabbar_scrollToEnd, "f"), disabled: this.disableEndArrow, iconOnly: true }))), ((this.level === 'root' &&
            (this.layer === 'popup' || this.layer === 'accessory')) ||
            (this.level === 'section' && this.layer === 'main')) && (index.h("qds-divider", { key: 'fd40c7eed666d65eba2972ab3b3f146f1feb4948', vertical: this.orientation === 'vertical' }))));
    }
