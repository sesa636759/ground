...
const Tab = class {
    ...
    componentWillLoad() {
        var _a;
        __classPrivateFieldSet(this, _Tab_inheritedAttributes, helpers.inheritAriaAttributes(this.host), "f");
    ...
    render() {
        ...
        const Tag = isLink
            ...
            : __classPrivateFieldGet(this, _Tab_instances, "a", _Tab_computedAction_get) === 'expandable'
                ? 'button'
                : 'div';
        return (index.h("div", { key: '9883de62c96b1138199aea9bd358dd1b1eff6368', "aria-disabled": __classPrivateFieldGet(this, _Tab_instances, "a", _Tab_computedDisabled_get) ? 'true' : undefined, class: {
...
_Tab_inheritedAttributes = new WeakMap(), _Tab_div = new WeakMap(), _Tab_panel = new WeakMap(), _Tab_ref = new WeakMap(), _Tab_tooltipRef = new WeakMap(), _Tab_close = new WeakMap(), _Tab_onIconClick = new WeakMap(), _Tab_onIconKeyDown = new WeakMap(), _Tab_onBlur = new WeakMap(), _Tab_onFocus = new WeakMap(), _Tab_instances = new WeakSet(), _Tab_collapsed_get = function _Tab_collapsed_get() {
    ...
    return __classPrivateFieldGet(this, _Tab_instances, "a", _Tab_shouldCollapse_get) ? (index.h("qds-title", { subtitle: this.subtitle, layer: "accessory", level: "root" }, this.text)) : (index.h("div", { class: "qds-texts" }, index.h("div", { class: "qds-text" }, this.text), this.subtitle !== undefined && this.subtitle !== '' && (index.h("div", { class: "qds-subtitle" }, this.subtitle))));
};
Tab.style = QdsTabStyle0;

exports.qds_tab = Tab;

//# sourceMappingURL=qds-tab.cjs.entry.js.map