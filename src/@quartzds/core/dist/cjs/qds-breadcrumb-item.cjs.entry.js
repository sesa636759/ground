...
const QdsBreadcrumbItem = class {
    constructor(hostRef) {
        ...
        _QdsBreadcrumbItem_internals.set(this, helpers.attachInternals.call(this));
    ...
    textChanged() {
        ...
        if (!__classPrivateFieldGet(this, _QdsBreadcrumbItem_span, "f"))
            return;
        this.tooltip = helpers.isOverflowing(__classPrivateFieldGet(this, _QdsBreadcrumbItem_span, "f"));
    ...
    render() {
        return (index.h("div", { key: '7640d08e7afe853363af70eae0e9ea3b3ec4a1f3', class: "qds-breadcrumb-item", ref: this.href === undefined ? __classPrivateFieldGet(this, _QdsBreadcrumbItem_breadcrumbItemRef, "f") : undefined, tabIndex: this.tooltip && this.href === undefined ? 0 : undefined }, this.href === undefined ? __classPrivateFieldGet(this, _QdsBreadcrumbItem_instances, "m", _QdsBreadcrumbItem_renderText).call(this) : __classPrivateFieldGet(this, _QdsBreadcrumbItem_instances, "m", _QdsBreadcrumbItem_renderAnchor).call(this), this.tooltip && (index.h("qds-tooltip", { key: 'feb66781c919e1139bb92b6174bada2f59e3bb45', "aria-hidden": "true", ref: __classPrivateFieldGet(this, _QdsBreadcrumbItem_tooltipRef, "f") }, this.text))));
    }
...
exports.qds_breadcrumb_item = QdsBreadcrumbItem;

//# sourceMappingURL=qds-breadcrumb-item.cjs.entry.js.map