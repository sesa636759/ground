...
const Dialog = class {
    constructor(hostRef) {
        ...
        this.cancelEmitter = index.createEvent(this, "qdsCancel", 1);
    ...
    render() {
        return (index.h(index.Host, { key: '29346ced1f939c79bd29ceda3567ef44a6e7fbae' }, index.h("dialog", { key: '694af8b162d1a54331b2fd252ea5c64db0444cfe', class: "qds-dialog", ref: __classPrivateFieldGet(this, _Dialog_ref, "f"), onCancel: __classPrivateFieldGet(this, _Dialog_onCancel, "f"), onClose: __classPrivateFieldGet(this, _Dialog_onClose, "f"), onSubmit: __classPrivateFieldGet(this, _Dialog_onSubmit, "f"), ...__classPrivateFieldGet(this, _Dialog_inheritedAttributes, "f") }, index.h("div", { key: '673df9f7738f0b4268fabc8cfd933d4fb425b062', class: "qds-content" }, index.h("slot", { key: '210ec0fd8c8951cd71f72c5f7f947a49e71900de' }))), index.h("div", { key: '50a645e89b9e692d4905cec55bd8a07337e4272d', class: "qds-backdrop" })));
    }
    show() {
        helpers.invariant(__classPrivateFieldGet(this, _Dialog_dialog, "f"));
...
//# sourceMappingURL=qds-dialog.cjs.entry.js.map