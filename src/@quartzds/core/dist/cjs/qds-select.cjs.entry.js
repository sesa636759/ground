...
const Select = class {
    constructor(hostRef) {
        ...
        this.setCustomValidity = (error) => {
            ...
            if (error)
                this.internals.setValidity(controls.CUSTOM_ERROR_FLAGS, error, __classPrivateFieldGet(this, _Select_select, "f"));
            else
    ...
    componentWillLoad() {
        ...
        __classPrivateFieldSet(this, _Select_inheritedAttributes, helpers.inheritAriaAttributes(this.host), "f");
...
exports.qds_select = Select;

//# sourceMappingURL=qds-select.cjs.entry.js.map