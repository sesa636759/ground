...
const Dropdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c192187f4fbe9fa2e166cb86b435c45c9d6d2a26', "aria-labelledby": this.hostAriaLabelledBy, onKeyDown: __classPrivateFieldGet(this, _Dropdown_onKeydown, "f"), onFocusout: __classPrivateFieldGet(this, _Dropdown_onFocusout, "f"), style: {
                display: this.hostDisplay,
                position: this.hostPosition,
                transform: this.hostTransform,
            } }, index.h("slot", { key: '41a6332566fe8e7e935f8f638367c3f0d9571cbe' })));
    }
    show() {
        if (__classPrivateFieldGet(this, _Dropdown_open, "f"))
            return;
