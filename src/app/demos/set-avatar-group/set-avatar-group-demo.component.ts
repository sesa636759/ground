...
import { DmSetAvatarGroupPlaygroundComponent } from '../../playground/sets/set-avatar-group-avatar-group-playground/set-avatar-group-avatar-group-playground.component';
...
@Component({
  ...
  imports: [
    CommonModule,
    DmSetAvatarGroupPlaygroundComponent,
    DemoTabsComponent,
