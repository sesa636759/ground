...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RoseChartPlaygroundComponent, DemoTabsComponent, DemoSidebarComponent, ComponentDocumentationComponent, DemoHeaderComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './rose-chart-demo.component.html',
  styleUrl: './rose-chart-demo.component.scss',
})
export class RoseChartDemoComponent {
  variants = [
    { id: 'playground', name: 'Playground',     icon: '🎮', color: '#8b5cf6' },
    { id: 'monthly',    name: 'Monthly Revenue', icon: '🌹', color: '#6366f1' },
    { id: 'performance',name: 'Performance',     icon: '📊', color: '#10b981' },
    { id: 'wind',       name: 'Wind Direction',  icon: '💨', color: '#0ea5e9' },
  ];
  ...
  perfData = {
    ...
    datasets: [{ data: [85, 92, 78, 95, 88, 76], backgroundColor: ['#6366f1','#10b981','#f59e0b','#0ea5e9','#f43f5e','#8b5cf6'], borderWidth: 1 }],
  };
