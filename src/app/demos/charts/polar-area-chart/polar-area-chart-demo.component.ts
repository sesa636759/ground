...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, PolarAreaChartPlaygroundComponent, DemoTabsComponent, DemoSidebarComponent, ComponentDocumentationComponent, DemoHeaderComponent],
...
export class PolarAreaChartDemoComponent {
  variants = [
    ...
    { id: 'skills',     name: 'Skills Radar',  icon: '🌐', color: '#6366f1' },
    { id: 'sales',      name: 'Sales Regions', icon: '🗺️',  color: '#10b981' },
    { id: 'multi',      name: 'Multi-Dataset', icon: '📊', color: '#0ea5e9' },
  ];
  ...
  skillsData = {
    ...
    datasets: [{ data: [85, 78, 65, 90, 72, 80], backgroundColor: ['#6366f1cc','#0ea5e9cc','#10b981cc','#f43f5ecc','#f59e0bcc','#8b5cf6cc'], borderWidth: 1 }],
  };

  salesData = {
    labels: ['North', 'South', 'East', 'West', 'Central'],
    datasets: [{ data: [42, 55, 30, 70, 48], backgroundColor: ['#6366f1cc','#0ea5e9cc','#10b981cc','#f43f5ecc','#f59e0bcc'], borderWidth: 1 }],
  };
