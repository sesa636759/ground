...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SparklinePlaygroundComponent, DemoTabsComponent, DemoSidebarComponent, ComponentDocumentationComponent, DemoHeaderComponent],
...
export class SparklineDemoComponent {
  variants = [
    ...
    { id: 'inline-kpi', name: 'Inline KPI',  icon: '📈', color: '#6366f1' },
    { id: 'table-row',  name: 'Table Row',   icon: '📊', color: '#10b981' },
    { id: 'dashboard',  name: 'Dashboard',   icon: '🖥️', color: '#f59e0b' },
  ];
