...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, AppInputValueAccessorDirective, AppCheckboxValueAccessorDirective, TogglePlaygroundComponent, CodeBlockComponent, DemoTabsComponent],
