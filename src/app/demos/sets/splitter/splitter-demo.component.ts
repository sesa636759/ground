...
export class DmSplitterDemoComponent {
  exampleVariants = [
    { id: 'horizontal-basic', title: 'Horizontal Basic', icon: '??' },
    { id: 'vertical-basic', title: 'Vertical Basic', icon: '??' },
    ...
    { id: 'equal-sizes', title: 'Equal Panel Sizes', icon: '??' },
    ...
    { id: 'not-animated', title: 'No Animation', icon: '??' },
    { id: 'rounded', title: 'Rounded Corners', icon: '??' },
    { id: 'elevated', title: 'Elevated Style', icon: '??' },
    ...
    { id: 'nested-triple', title: 'Triple Nested', icon: '???' },
