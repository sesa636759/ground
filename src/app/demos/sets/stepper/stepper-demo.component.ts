...
import { DmStepperSetPlaygroundComponent } from '../../../playground/sets/stepper-playground/stepper-playground.component';
...
@Component({
  selector: 'dm-stepper-set-demo',
  imports: [
    ...PLAYGROUND_IMPORTS,
    DmStepperSetPlaygroundComponent,
    DemoTabsComponent,
