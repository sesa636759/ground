...
import { DmTabsSetPlaygroundComponent } from '../../../playground/sets/tabs-playground/tabs-playground.component';
...
@Component({
  selector: 'dm-tabs-set-demo',
  standalone: true,
  imports: [
    ...PLAYGROUND_IMPORTS,
    DmTabsSetPlaygroundComponent,
    DemoTabsComponent,
