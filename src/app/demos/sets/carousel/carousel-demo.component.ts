...
import { DmCarouselSetPlaygroundComponent } from '../../../playground/sets/carousel-playground/carousel-playground.component';
...
@Component({
  selector: 'dm-carousel-set-demo',
  standalone: true,
  imports: [
    ...PLAYGROUND_IMPORTS,
    DmCarouselSetPlaygroundComponent,
    DemoTabsComponent,
