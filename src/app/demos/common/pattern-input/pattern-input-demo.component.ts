...
export class DmPatternInputDemoComponent extends BaseDemoComponent {
  exampleVariants = [
    ...
    { id: 'restrictions', title: 'Strict Restrictions', icon: 'shield-alert', iconLibrary: 'lucide' },
    { id: 'validation', title: 'Validation & States', icon: 'shield-check', iconLibrary: 'lucide' },
  ];

  basicCode = signal(`<ui-pattern-input pattern="(###) ###-####" label="Phone Number"></ui-pattern-input>
...
<ui-pattern-input pattern="##/##/####" placeholder="MM/DD/YYYY" label="Date"></ui-pattern-input>`);
  ...
  identityCode = signal(`<ui-pattern-input label="Canadian Postal Code" pattern="A#A #A#" input-type="alphanumeric" placeholder="K1A 0B1"></ui-pattern-input>
...
<ui-pattern-input label="Passport ID" pattern="AAAAAAAAA" input-type="alphanumeric" placeholder="A12345678"></ui-pattern-input>`);
  ...
  temporalCode = signal(`<ui-pattern-input label="Time (24h)" pattern="##:##:##" placeholder="14:30:59"></ui-pattern-input>
...
<ui-pattern-input label="YYYY/MM/DD" pattern="####/##/##" placeholder="2024/12/31"></ui-pattern-input>`);
  ...
  techCode = signal(`<ui-pattern-input label="IPv4 Address" pattern="###.###.###.###" placeholder="192.168.001.001"></ui-pattern-input>
...
<ui-pattern-input label="UUID / GUID" pattern="AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA" placeholder="550e8400-e29b-..."></ui-pattern-input>`);
  ...
  businessCode = signal(`<ui-pattern-input label="Product SKU" pattern="AAA-####-AA" input-type="alphanumeric" placeholder="PRD-2024-XL"></ui-pattern-input>
...
<ui-pattern-input label="License Key" pattern="AAAA-AAAA-AAAA-AAAA" placeholder="ABCD-EFGH-1234-5678"></ui-pattern-input>`);
  ...
  financeCode = signal(`<ui-pattern-input label="Bank Routing (US)" pattern="####-####-#" placeholder="1234-5678-9"></ui-pattern-input>
...
<ui-pattern-input label="CVV / CVC" pattern="###" maxLength="3" placeholder="123"></ui-pattern-input>`);
  ...
  variantsCode = signal(`<ui-pattern-input size="sm" pattern="#####" label="Small (Zip)"></ui-pattern-input>
...
></ui-pattern-input>`);
  ...
  restrictionsCode = signal(`<ui-pattern-input input-type="numeric" label="Strictly Numeric"></ui-pattern-input>
...
<ui-pattern-input input-type="custom" allowed-chars="[A-F0-9]" label="HEX Restricted"></ui-pattern-input>`);
  ...
  formattingCode = signal(`<ui-pattern-input mask-char="*" pattern="****-****-****-****" label="Custom Mask Char"></ui-pattern-input>
