...
export class DmDropdownDemoComponent extends BaseDemoComponent {
  exampleVariants = [
    ...
    { id: 'selection-modes', title: 'Selection Modes', icon: 'check-square', iconLibrary: 'lucide' },
  ...
  premiumOptions = [
    { label: 'Cloud Storage', value: 'cloud', icon: 'cloud', subtitle: 'AWS / GCP / Azure', rightTag: 'Premium', rightTagColor: 'info' },
    { label: 'On-Premise', value: 'local', icon: 'home', subtitle: 'Private Server', rightIcon: 'lock' },
    { label: 'Hybrid Solution', value: 'hybrid', icon: 'git-branch', description: 'Mixed infrastructure' },
  ];
  ...
  cascadingOptions = [
    {
      ...
      children: [
        ...
        { label: 'BMW', value: 'bmw', children: [{ label: 'Series 3', value: '3' }, { label: 'Series 5', value: '5' }] },
      ],
    },
    {
      label: 'Bikes',
