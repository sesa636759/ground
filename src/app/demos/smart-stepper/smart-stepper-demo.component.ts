...
import { DmSmartStepperPlaygroundComponent } from '../../playground/common/smart-stepper-playground/smart-stepper-playground.component';
...
@Component({
  ...
  imports: [
    ...PLAYGROUND_IMPORTS,
    DmSmartStepperPlaygroundComponent,
    DemoTabsComponent,
