...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, AppInputValueAccessorDirective, AppCheckboxValueAccessorDirective, SidebarPlaygroundComponent, CodeBlockComponent, DemoTabsComponent],
