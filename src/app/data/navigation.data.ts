...
export const categoryNavItems: NavItem[] = [

  {
    ...
    children: [
      ...
      { id: 'charts/area-chart',       label: 'Area Chart',         icon: '🏔️' },
      { id: 'charts/timeline-range',   label: 'Timeline Range',     icon: '📅' },
      { id: 'charts/sparkline',        label: 'Sparkline',          icon: '📉' },
      { id: 'charts/radial-bar',       label: 'Radial Bar',         icon: '🎯' },
      { id: 'charts/gantt-chart',      label: 'Gantt Chart',        icon: '📋' },
      { id: 'charts/step-line-chart',  label: 'Step Line',          icon: '🪜' },
      { id: 'charts/waterfall-chart',  label: 'Waterfall',          icon: '💧' },
      { id: 'charts/funnel-chart',     label: 'Funnel Chart',       icon: '🔺' },
      { id: 'charts/rose-chart',       label: 'Rose Chart',         icon: '🌹' },
      { id: 'charts/lollipop-chart',   label: 'Lollipop',           icon: '🍭' },
      { id: 'charts/polar-area-chart', label: 'Polar Area',         icon: '🌐' },
      { id: 'charts/candlestick-chart',label: 'Candlestick',        icon: '🕯️' },
      { id: 'charts/ohlc-chart',       label: 'OHLC Chart',         icon: '📊' },
      { id: 'charts/tree-diagram',     label: 'Tree Diagram',       icon: '🌳' },
    ],
  },
