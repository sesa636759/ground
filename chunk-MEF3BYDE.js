import{Da as b,Db as L,Dc as O,Ea as _,Fb as x,Gb as p,Ha as e,U as C,Ua as M,V as g,W as f,X as m,aa as v,db as s,eb as a,mb as n,nb as l,ob as y,rb as P,sb as u,ub as w,vb as c}from"./chunk-SRT4OEMB.js";var o={accordion:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,anchor:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,aside:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,avatar:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"avatar-group":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,badge:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"bar-chart":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,breadcrumb:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,button:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,card:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"cascade-select":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,chart:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,checkbox:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,chip:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"context-menu":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"dialog-box":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,divider:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,dock:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,dropdown:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"horizontal-nav":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,knob:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"layout-manager":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"meter-group":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"nav-bar":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,pagination:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,panel:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"pattern-input":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,picklist:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,pill:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,popover:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"range-slider":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,rating:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"scroll-top":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,skeleton:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"smart-menu":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"smart-stepper":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,snackbar:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"speed-dial":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,speedometer:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"split-button":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,stack:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,stepper:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,switch:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,tabs:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,tag:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,timeline:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,timer:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"top-bar":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"transfer-list":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="5"   y="5"  width="72" height="80" rx="8" fill="currentColor" fill-opacity=".06" stroke="currentColor" stroke-width="1.5"/>
    <rect x="123" y="5"  width="72" height="80" rx="8" fill="currentColor" fill-opacity=".06" stroke="currentColor" stroke-width="1.5"/>
    <line x1="15" y1="22" x2="67"  y2="22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity=".6"/>
    <line x1="15" y1="34" x2="67"  y2="34" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity=".5"/>
    ...
    <line x1="133" y1="34" x2="185" y2="34" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity=".4"/>
    <line x1="133" y1="65" x2="185" y2="65" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" opacity=".35"/>
  </svg>`,"tree-list":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,carousel:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"code-editor":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,dashboard:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"button-toggle":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"advanced-data-table":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,"animate-on-scroll":`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`,default:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`};o["set-carousel"]=o.carousel;o["set-code-editor"]=o["code-editor"];o["set-dashboard"]=o.dashboard;o["set-button-toggle"]=o["button-toggle"];o["set-checkbox"]=o.checkbox;o["set-card"]=o.card;o["set-avatar"]=o.avatar;o["set-avatar-group"]=o["avatar-group"];o["set-context-menu"]=o["context-menu"];o["set-anchor"]=o.anchor;o["set-animate-on-scroll"]=o["animate-on-scroll"];function B(r,d){if(r&1&&y(0,"ui-icon",4),r&2){let t=c();u("name",t.icon)("library",t.iconLibrary)}}function E(r,d){if(r&1&&(n(0,"span"),x(1),l()),r&2){let t=c();e(),p(t.label.charAt(0))}}function j(r,d){if(r&1&&(n(0,"span",7),x(1),l()),r&2){let t=c();e(),p(t.category)}}function S(r,d){if(r&1&&(n(0,"span",8),x(1),l()),r&2){let t=c();e(),p(t.badge)}}function z(r,d){if(r&1&&y(0,"div",11),r&2){let t=c(2);u("innerHTML",t.previewSvg,b)}}function T(r,d){if(r&1&&y(0,"img",12),r&2){let t=c(2);u("src",t.imageUrl,_)("alt",t.label)}}function I(r,d){if(r&1){let t=P();n(0,"div",9),s(1,z,1,1,"div",11),s(2,T,1,2,"img",12),n(3,"div",13)(4,"div",14)(5,"ui-button",15),w("click",function(i){C(t);let h=c();return g(h.onDemoClick(i))}),f(),n(6,"svg",16),y(7,"line",17)(8,"polyline",18),l()(),m(),n(9,"ui-button",19),w("click",function(i){C(t);let h=c();return g(h.onDocsClick(i))}),f(),n(10,"svg",16),y(11,"path",20)(12,"path",21),l()()()()()}if(r&2){let t=c();e(),a(t.imageUrl?-1:1),e(),a(t.imageUrl?2:-1)}}function A(r,d){if(r&1&&(n(0,"div",10)(1,"p",22),x(2),l()()),r&2){let t=c();e(2),p(t.description)}}var Q=(()=>{class r{componentId;label;category;icon;iconLibrary="lucide";badge;description;previewSvg;imageUrl;viewMode="grid";cardClick=new v;docsClick=new v;onDemoClick(t){t&&t.stopPropagation(),this.cardClick.emit(this.componentId)}onDocsClick(t){t.stopPropagation(),this.docsClick.emit(this.componentId)}static \u0275fac=function(k){return new(k||r)};static \u0275cmp=M({type:r,selectors:[["app-component-card"]],inputs:{componentId:"componentId",label:"label",category:"category",icon:"icon",iconLibrary:"iconLibrary",badge:"badge",description:"description",previewSvg:"previewSvg",imageUrl:"imageUrl",viewMode:"viewMode"},outputs:{cardClick:"cardClick",docsClick:"docsClick"},decls:13,vars:9,consts:[[1,"component-card","glass-panel",3,"click"],[1,"card-glow"],[1,"card-header"],[1,"comp-avatar"],["size","22","color","white",3,"name","library"],[1,"comp-title-area"],[1,"comp-name"],[1,"comp-meta"],[1,"status-badge"],[1,"card-preview-container"],[1,"card-footer"],[1,"card-preview",3,"innerHTML"],[1,"card-image",3,"src","alt"],[1,"preview-overlay"],[1,"overlay-actions"],["label","Demo",1,"explore-btn",3,"click"],["width","16","height","16","viewBox","0 0 24 24","fill","none","stroke","currentColor","stroke-width","2"],["x1","5","y1","12","x2","19","y2","12"],["points","12 5 19 12 12 19"],["label","API","variant","ghost",1,"docs-btn",3,"click"],["d","M4 19.5A2.5 2.5 0 0 1 6.5 17H20"],["d","M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"],[1,"card-description"]],template:function(k,i){k&1&&(n(0,"div",0),w("click",function(){return i.onDemoClick()}),y(1,"div",1),n(2,"div",2)(3,"div",3),s(4,B,1,2,"ui-icon",4),s(5,E,2,1,"span"),l(),n(6,"div",5)(7,"h3",6),x(8),l(),s(9,j,2,1,"span",7),l(),s(10,S,2,1,"span",8),l(),s(11,I,13,2,"div",9),s(12,A,3,1,"div",10),l()),k&2&&(L("list-card",i.viewMode==="list"),e(4),a(i.icon?4:-1),e(),a(i.icon?-1:5),e(3),p(i.label),e(),a(i.category?9:-1),e(),a(i.badge?10:-1),e(),a(i.viewMode!=="list"?11:-1),e(),a(i.description?12:-1))},dependencies:[O],styles:['@charset "UTF-8";[_nghost-%COMP%]{display:block;height:100%;break-inside:avoid;-webkit-column-break-inside:avoid;margin-bottom:var(--am-row-gap, 32px)}.component-card[_ngcontent-%COMP%]{padding:1.75rem;cursor:pointer;display:flex;flex-direction:column;height:100%;min-height:180px;background:var(--bg-glass, rgba(30, 41, 59, .4));backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid var(--border-subtle, rgba(255, 255, 255, .05));border-radius:20px;box-shadow:10px 10px 30px #0003,inset 0 0 0 1px var(--border-subtle, rgba(255, 255, 255, .05));transition:all .4s cubic-bezier(.2,.8,.2,1);position:relative;overflow:hidden}.component-card[_ngcontent-%COMP%]:before{content:"";position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--primary, #4f46e5),var(--primary-light, #6366f1),var(--primary-lighter, #818cf8));opacity:0;transition:opacity .4s ease;z-index:2}.component-card[_ngcontent-%COMP%]:after{content:"";position:absolute;inset:0;z-index:1;background:linear-gradient(115deg,transparent 20%,rgba(255,255,255,.8) 40%,rgba(255,255,255,.9) 50%,transparent 80%);background-size:200% 100%;background-position:-200% center;transition:background-position .1s ease;pointer-events:none;opacity:0}.component-card[_ngcontent-%COMP%]:hover{transform:translateY(-8px) scale(1.02);box-shadow:0 24px 48px -12px color-mix(in srgb,var(--primary) 20%,transparent),0 0 0 1px var(--primary);background:var(--bg-glass-hover, rgba(30, 41, 59, .7))}.component-card[_ngcontent-%COMP%]:hover:before{opacity:1}.component-card[_ngcontent-%COMP%]:hover:after{opacity:1;background-position:200% center;transition:background-position .9s cubic-bezier(.4,0,.2,1)}.component-card[_ngcontent-%COMP%]:hover   .comp-avatar[_ngcontent-%COMP%]{transform:scale(1.12) rotate(-6deg)}.card-header[_ngcontent-%COMP%]{position:relative;z-index:2;display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem}.card-header[_ngcontent-%COMP%]   .comp-avatar[_ngcontent-%COMP%]{width:48px;height:48px;background:var(--gradient-primary, linear-gradient(135deg, var(--primary, #4f46e5) 0%, var(--primary-light, #6366f1) 100%));color:#fff;display:flex;align-items:center;justify-content:center;border-radius:14px;box-shadow:0 4px 14px color-mix(in srgb,var(--primary, #4f46e5) 32%,transparent);transition:transform .3s ease;flex-shrink:0;font-size:1.2rem;font-weight:800}.card-header[_ngcontent-%COMP%]   .comp-avatar[_ngcontent-%COMP%]   ui-icon[_ngcontent-%COMP%]{color:#fff;--icon-color: white;display:flex;align-items:center;justify-content:center}.card-header[_ngcontent-%COMP%]   .comp-title-area[_ngcontent-%COMP%]{flex:1;margin:0 .75rem;min-width:0}.card-header[_ngcontent-%COMP%]   .comp-title-area[_ngcontent-%COMP%]   .comp-name[_ngcontent-%COMP%]{font-size:1.15rem;font-weight:800;color:var(--text-primary, #ffffff);letter-spacing:-.025em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin:0 0 .2rem}.card-header[_ngcontent-%COMP%]   .comp-title-area[_ngcontent-%COMP%]   .comp-meta[_ngcontent-%COMP%]{font-size:.7rem;color:var(--text-muted, #94a3b8);text-transform:uppercase;letter-spacing:.05em;font-weight:600;display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.card-header[_ngcontent-%COMP%]   .status-badge[_ngcontent-%COMP%]{font-size:.62rem;font-weight:900;color:var(--success, #10b981);letter-spacing:.06em;background:color-mix(in srgb,var(--success, #10b981) 10%,transparent);border:1px solid color-mix(in srgb,var(--success, #10b981) 30%,transparent);padding:3px 9px;border-radius:100px;white-space:nowrap}.card-preview-container[_ngcontent-%COMP%]{position:relative;z-index:2;width:100%;height:140px;background:var(--bg-glass, rgba(15, 23, 42, .5));border-radius:12px;margin-bottom:1.1rem;overflow:hidden;border:1px solid var(--border-subtle, rgba(255, 255, 255, .05));color:var(--primary, #4f46e5);display:flex;align-items:center;justify-content:center;transition:background .3s ease}.card-preview-container[_ngcontent-%COMP%]   .card-preview[_ngcontent-%COMP%]{width:100%;height:100%;display:flex;align-items:center;justify-content:center}.card-preview-container[_ngcontent-%COMP%]   .card-preview[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%]{width:80%;height:80%;display:block}.card-preview-container[_ngcontent-%COMP%]   .card-image[_ngcontent-%COMP%]{width:100%;height:100%;object-fit:cover;display:block;transition:transform .4s cubic-bezier(.2,.8,.2,1)}.component-card[_ngcontent-%COMP%]:hover   .card-preview-container[_ngcontent-%COMP%]   .card-image[_ngcontent-%COMP%]{transform:scale(1.05)}.component-card[_ngcontent-%COMP%]:hover   .card-preview-container[_ngcontent-%COMP%]{background:color-mix(in srgb,var(--primary, #4f46e5) 9%,var(--bg-tertiary, #f8fafc))}.preview-overlay[_ngcontent-%COMP%]{position:absolute;inset:0;background:color-mix(in srgb,var(--surface-1) 70%,transparent);-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;opacity:0;transition:opacity .3s ease}.component-card[_ngcontent-%COMP%]:hover   .preview-overlay[_ngcontent-%COMP%]{opacity:1}.overlay-actions[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:12px;align-items:center;transform:translateY(15px);transition:transform .4s cubic-bezier(.2,.8,.2,1)}.component-card[_ngcontent-%COMP%]:hover   .overlay-actions[_ngcontent-%COMP%]{transform:translateY(0)}.explore-btn[_ngcontent-%COMP%], .docs-btn[_ngcontent-%COMP%]{width:130px;height:38px;border-radius:12px;font-weight:800;font-size:.8rem;letter-spacing:.02em;--ui-button-padding: 0 12px}.explore-btn[_ngcontent-%COMP%]::part(button), .docs-btn[_ngcontent-%COMP%]::part(button){display:flex;align-items:center;justify-content:center;gap:8px}.explore-btn[_ngcontent-%COMP%]{--ui-button-bg: var(--primary, #4f46e5);--ui-button-color: white;box-shadow:0 8px 16px -4px #4f46e580;transition:all .3s ease}.explore-btn[_ngcontent-%COMP%]:hover{transform:scale(1.05);box-shadow:0 12px 20px -4px #4f46e599}.docs-btn[_ngcontent-%COMP%]{--ui-button-bg: rgba(255, 255, 255, .15);--ui-button-color: white;-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.3);transition:all .3s ease}.docs-btn[_ngcontent-%COMP%]:hover{background:#ffffff40;transform:scale(1.05)}.card-footer[_ngcontent-%COMP%]{position:relative;z-index:2;flex:1;display:flex;flex-direction:column;justify-content:flex-end}.card-footer[_ngcontent-%COMP%]   .card-description[_ngcontent-%COMP%]{font-size:.875rem;color:var(--text-secondary, #94a3b8);line-height:1.6;margin:0;display:-webkit-box;-webkit-line-clamp:2;line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.list-card[_ngcontent-%COMP%]{flex-direction:row;align-items:center;padding:16px 24px;gap:24px;min-height:auto}.list-card[_ngcontent-%COMP%]   .card-preview-container[_ngcontent-%COMP%]{display:none}.list-card[_ngcontent-%COMP%]   .card-header[_ngcontent-%COMP%]{margin-bottom:0;width:300px}.list-card[_ngcontent-%COMP%]   .card-footer[_ngcontent-%COMP%]{flex:1;justify-content:center}.list-card[_ngcontent-%COMP%]   .card-footer[_ngcontent-%COMP%]   .card-description[_ngcontent-%COMP%]{-webkit-line-clamp:1;line-clamp:1}']})}return r})();export{o as a,Q as b};
