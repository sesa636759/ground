var r={accordion:`<svg viewBox="0 0 200 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  </svg>`};r["set-carousel"]=r.carousel;r["set-code-editor"]=r["code-editor"];r["set-dashboard"]=r.dashboard;r["set-button-toggle"]=r["button-toggle"];r["set-checkbox"]=r.checkbox;r["set-card"]=r.card;r["set-avatar"]=r.avatar;r["set-avatar-group"]=r["avatar-group"];r["set-context-menu"]=r["context-menu"];r["set-anchor"]=r.anchor;r["set-animate-on-scroll"]=r["animate-on-scroll"];export{r as a};
